    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.imgclass}>
                <Image className={styles.img} width={250} height={250} src='/promo.jpg' />
                <Image className={styles.img} width={250} height={250} src='/clo.jpg' />
                <Image className={styles.img} width={250} height={250} src='/pr-07.jpg' />
                <Image className={styles.img} width={250} height={250} src='/promo.jpg' />
                <Image className={styles.img} width={250} height={250} src='/clo.jpg' />
                <Image className={styles.img} width={250} height={250} src='/pr-07.jpg' />
                <Image className={styles.img} width={250} height={250} src='/promo.jpg' />
